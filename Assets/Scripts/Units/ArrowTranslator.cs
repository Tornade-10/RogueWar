...
namespace Units
{
    public class ArrowTranslator
    {
        ...
        public ArrowDirection TranslateDirection(OverlayTile previousTile, OverlayTile currentTile, OverlayTile futureTile)
        {
            ...
            Vector2Int pastDirection = previousTile != null ? currentTile.gridLocation - previousTile.gridLocation : new Vector2Int(0, 0);
            Vector2Int futureDirection = futureTile != null ? futureTile.gridLocation - currentTile.gridLocation : new Vector2Int(0, 0);
